  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `https://esystems.cdl.lk/backend/GateSolution/UhfRfid/PostRegTag?Sno=${formData.Sno}&Rname=${formData.Rname}&VehicleType=${formData.VehicleType}&VehicleNo=${formData.VehicleNo}&VehicleRfidTag=${formData.VehicleRfidTag}`,
        {
          method: "POST",
          headers: {
        ...
        <div className="input-box">
          ...
          <div className="input-box">
            ...
            {formErrors.UserStatus && (
              <span className="error-message">User status required</span>
            )}
          </div>
